...
const megaGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    color: "#1E6B4F",
    items: [
      { label: "India Entry Strategies", slug: "entry-india-strategies" },
      ...
      { label: "Startup India Registration", slug: "startup-registration" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Bookkeeping & Accounting Services", slug: "bookkeeping-accounting-international" },
