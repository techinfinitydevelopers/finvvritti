      ...
      <div className="container-x grid md:grid-cols-12 gap-8 md:gap-10">
        <div className="md:col-span-5">
          ...
          <p className="mt-4 text-white/70 max-w-md leading-relaxed">
            Finvvritti provides accurate <strong className="text-white font-semibold">Accounting</strong> and trusted <strong className="text-white font-semibold">Financial Advisory</strong> services for growing businesses.
          </p>
