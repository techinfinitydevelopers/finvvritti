...
export default async function OGImage() {
  // Fetch the logo as base64 for edge runtime
  const logoUrl = new URL("/logo-light.png", "https://finvvritti.com").toString();
    ...
    (
      ...
      >
        ...
        >
          ...
          <img src={logoBase64} alt="Finvvritti" style={{ width: 260, height: "auto" }} />
        </div>
